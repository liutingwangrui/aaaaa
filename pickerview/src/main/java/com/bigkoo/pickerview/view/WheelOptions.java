...
public class WheelOptions<T> {
    private View view;
    private WheelViewNoHour wv_option1;
    private WheelViewNoHour wv_option2;
    private WheelViewNoHour wv_option3;
    ...
    public WheelOptions(View view, boolean isRestoreItem) {
        ...
        this.view = view;
        wv_option1 = (WheelViewNoHour) view.findViewById(R.id.options1);// 初始化时显示的数据
        wv_option2 = (WheelViewNoHour) view.findViewById(R.id.options2);
        wv_option3 = (WheelViewNoHour) view.findViewById(R.id.options3);
    }

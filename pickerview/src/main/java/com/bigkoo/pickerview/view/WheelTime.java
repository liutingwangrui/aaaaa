...
public class WheelTime {
    ...
    private View view;
    private WheelViewNoHour wv_year;
    private WheelViewNoHour wv_month;
    private WheelViewNoHour wv_day;
    private WheelViewNoHour wv_hours;
    private WheelViewNoHour wv_minutes;
    private WheelViewNoHour wv_seconds;
    private int gravity;
    ...
    private WheelViewNoHour.DividerType dividerType;
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        // 年
        wv_year = (WheelViewNoHour) view.findViewById(R.id.year);
        ...
        // 月
        wv_month = (WheelViewNoHour) view.findViewById(R.id.month);
        ...
        // 日
        wv_day = (WheelViewNoHour) view.findViewById(R.id.day);
        ...
        wv_hours = (WheelViewNoHour) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        //wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_minutes = (WheelViewNoHour) view.findViewById(R.id.min);
        ...
        wv_seconds = (WheelViewNoHour) view.findViewById(R.id.second);
    ...
    private void setChangedListener(WheelViewNoHour wheelViewNoHour) {
        if (mSelectChangeCallback != null) {
            wheelViewNoHour.setOnItemSelectedListener(new OnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
                    mSelectChangeCallback.onTimeSelectChanged();
                }
...
//                maxItem = endD;
     ...
     * @param dividerType
     */
    public void setDividerType(WheelViewNoHour.DividerType dividerType) {
